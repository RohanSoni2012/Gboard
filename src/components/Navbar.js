    ...
    <nav className={`navbar navbar-expand-lg navbar-${props.mode} bg-${props.mode} `}>
      <div className="container-fluid">
        ...
        <div className="collapse navbar-collapse" id="navbarSupportedContent">
          ...
          {/* <div className={`form-check form-switch text-${props.modeM==='light'?'#ff0000':'light'}`}>
    <input className="form-check-input" onChnage = {props.toggleModeM} type="checkbox" role="switch" id="flexSwitchCheckDefault"/>
